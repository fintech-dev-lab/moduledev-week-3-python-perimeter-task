...
Сдача должна запускаться с чистой БД по README без недокументированного вмешательства.
Укажите обязательную конфигурацию, ожидаемый readiness и команду проверки именно этой недели.
Перед сдачей перепроверьте ранее полученные замечания; их сохранение подтверждается
сопоставлением старого и нового результата, а не предположением проверяющего.
